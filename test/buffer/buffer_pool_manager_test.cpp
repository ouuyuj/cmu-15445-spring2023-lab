...
TEST(BufferPoolManagerTest, BinaryDataTest1) {
...
TEST(BufferPoolManagerTest, SampleTest) {
  ...
  for (size_t i = 1; i < buffer_pool_size; ++i) {
    ...
    snprintf(page1->GetData(), BUSTUB_PAGE_SIZE, "Hello");
    EXPECT_EQ(0, strcmp(page1->GetData(), "Hello"));
  }
  ...
  EXPECT_EQ(true, bpm->UnpinPage(6, true));
  EXPECT_EQ(true, bpm->UnpinPage(8, true));
  EXPECT_EQ(true, bpm->UnpinPage(9, true));
  ...
  page0 = bpm->FetchPage(6);
  EXPECT_EQ(0, strcmp(page0->GetData(), "Hello"));

  page0 = bpm->FetchPage(7);
  EXPECT_EQ(0, strcmp(page0->GetData(), "Hello"));

  page0 = bpm->FetchPage(8);
  EXPECT_EQ(0, strcmp(page0->GetData(), "Hello"));
